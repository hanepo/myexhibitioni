...
class ExhibitionOngoingPage extends StatefulWidget {
  final String? docId;
  final Map<String, dynamic>? data;
  const ExhibitionOngoingPage({super.key, this.docId, this.data});

  @override
  State<ExhibitionOngoingPage> createState() => _ExhibitionOngoingPageState();
}

class _ExhibitionOngoingPageState extends State<ExhibitionOngoingPage> {
  ...
  static const Map<String, Map<String, String>> _booths = {
    'A-1': {'size': '16 sqm', 'type': 'PREMIUM'},
    'A-2': {'size': '16 sqm', 'type': 'PREMIUM'},
    'A-3': {'size': '16 sqm', 'type': 'PREMIUM'},
    'A-4': {'size': '12 sqm', 'type': 'STANDARD'},
    'A-5': {'size': '12 sqm', 'type': 'STANDARD'},
    'A-6': {'size': '12 sqm', 'type': 'STANDARD'},
    'A-7': {'size': '12 sqm', 'type': 'STANDARD'},
    'A-8': {'size': '9 sqm',  'type': 'BUDGET'},
  };
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: const Text('ONGOING', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 12, letterSpacing: 1.1, color: Colors.blue)),
            ),
              ...
              child: Column(
                children: [
                  Container(
                    ...
                    child: const Text('MAIN ENTRANCE / FRONT STAGE', textAlign: TextAlign.center, style: TextStyle(fontSize: 10, fontWeight: FontWeight.bold, letterSpacing: 1.2)),
                  ),
                  GridView.count(
                    shrinkWrap: true,
